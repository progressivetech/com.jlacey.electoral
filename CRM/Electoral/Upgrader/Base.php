 ...
 */
class CRM_Electoral_Upgrader_Base {

  /**
   * @var CRM_Electoral_Upgrader_Base
   */
   ...
   *
   * ```
   * CRM_Electoral_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Electoral_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
