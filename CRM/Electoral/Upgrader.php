...
class CRM_Electoral_Upgrader extends CRM_Electoral_Upgrader_Base {
  ...
  public function upgrade_1001() {
    ...
    $exists = (bool) \Civi\Api4\CustomField::get(FALSE)->addWhere('name', '=', 'electoral_note')->execute()->count();
    if (!$exists) {
    ...
    $exists = (bool) \Civi\Api4\CustomField::get(FALSE)->addWhere('name', '=', 'electoral_modified_date')->execute()->count();
    if (!$exists) {
      \Civi\Api4\CustomField::create(FALSE)
  ...
  public function upgrade_1002() {
    ...
    $exists = (bool) \Civi\Api4\OptionValue::get(FALSE)->addWhere('value', '=', 'legislative')->addWhere('option_group_id:name', '=', 'electoral_districts_level_options')->execute()->count();
    if (!$exists) {
    ...
    $exists = (bool) \Civi\Api4\OptionValue::get(FALSE)->addWhere('value', '=', 'judicial')->addWhere('option_group_id:name', '=', 'electoral_districts_level_options')->execute()->count();
    if (!$exists) {
      \Civi\Api4\OptionValue::create(FALSE)
    ...
    $exists = (bool) \Civi\Api4\OptionValue::get(FALSE)->addWhere('value', '=', 'police')->addWhere('option_group_id:name', '=', 'electoral_districts_level_options')->execute()->count();
    if (!$exists) {
      \Civi\Api4\OptionValue::create(FALSE)
    ...
    $exists = (bool) \Civi\Api4\OptionValue::get(FALSE)->addWhere('value', '=', 'school')->addWhere('option_group_id:name', '=', 'electoral_districts_level_options')->execute()->count();
    if (!$exists) {
      \Civi\Api4\OptionValue::create(FALSE)
    ...
    $exists = (bool) \Civi\Api4\OptionValue::get(FALSE)->addWhere('value', '=', 'voting')->addWhere('option_group_id:name', '=', 'electoral_districts_level_options')->execute()->count();
    if (!$exists) {
      \Civi\Api4\OptionValue::create(FALSE)
  ...
  public function upgrade_1003() {
    ...
    $exists = (bool) \Civi\Api4\CustomField::get(FALSE)->addWhere('name', '=', 'electoral_valid_from')->execute()->count();
    if (!$exists) {
      \Civi\Api4\CustomField::create(FALSE)
    ...
    $exists = (bool) \Civi\Api4\CustomField::get(FALSE)->addWhere('name', '=', 'electoral_valid_to')->execute()->count();
    if (!$exists) {
      \Civi\Api4\CustomField::create(FALSE)
  ...
  public function upgrade_1004() {
    ...
    $exists = (bool) \Civi\Api4\CustomField::get(FALSE)->addWhere('name', '=', 'electoral_ocd_id_district')->execute()->count();
    if (!$exists) {
      \Civi\Api4\CustomField::create(FALSE)
  ...
  private function addOfficialData() {
    $exists = (bool) \Civi\Api4\ContactType::get(FALSE)->addWhere('name', '=', 'Official')->execute()->count();
    if (!$exists) {
    ...
    $exists = (bool) \Civi\Api4\CustomGroup::get(FALSE)->addWhere('name', '=', 'official_info')->execute()->count();
    if (!$exists) {
    ...
    $exists = (bool) \Civi\Api4\CustomField::get(FALSE)->addWhere('name', '=', 'electoral_office')->execute()->count();
    if (!$exists) {
      \Civi\Api4\CustomField::create(FALSE)
    ...
    $exists = (bool) \Civi\Api4\CustomField::get(FALSE)->addWhere('name', '=', 'electoral_party')->execute()->count();
    if (!$exists) {
      \Civi\Api4\CustomField::create(FALSE)
    ...
    $exists = (bool) \Civi\Api4\CustomField::get(FALSE)->addWhere('name', '=', 'electoral_ocd_id_official')->execute()->count();
    if (!$exists) {
      \Civi\Api4\CustomField::create(FALSE)
    ...
    $exists = (bool) \Civi\Api4\CustomField::get(FALSE)->addWhere('name', '=', 'electoral_current_term_start_date')->execute()->count();
    if (!$exists) {
      \Civi\Api4\CustomField::create(FALSE)
    ...
    $exists = (bool) \Civi\Api4\CustomField::get(FALSE)->addWhere('name', '=', 'electoral_term_end_date')->execute()->count();
    if (!$exists) {
      \Civi\Api4\CustomField::create(FALSE)
  ...
  private function addDataProviders() {
    $exists = (bool) \Civi\Api4\OptionGroup::get(FALSE)->addWhere('name', '=', 'electoral_api_data_providers')->execute()->count();
    if ($exists) {
      return TRUE;
    }
  ...
  private function addChamberOptions() {
    $exists = (bool) \Civi\Api4\OptionGroup::get(FALSE)->addWhere('name', '=', 'electoral_districts_chamber_options')->execute()->count();
    if ($exists) {
      return TRUE;
    }
    $results = \Civi\Api4\OptionGroup::create(FALSE)
  ...
  private function addLevelOptions() {
    $exists = (bool) \Civi\Api4\OptionGroup::get(FALSE)->addWhere('name', '=', 'electoral_districts_level_options')->execute()->count();
    if ($exists) {
      return TRUE;
    }
    $results = \Civi\Api4\OptionGroup::create(FALSE)
