...
return [
  ...
  [
    'name' => 'CustomGroup_official_info_CustomField_electoral_official_chamber',
    'entity' => 'CustomField',
    'cleanup' => 'unused',
    'update' => 'unmodified',
    'params' => [
      ...
      'values' => [
        'custom_group_id.name' => 'official_info',
        'name' => 'electoral_official_chamber',
        'label' => 'Chamber',
        'data_type' => 'String',
        'html_type' => 'Select',
        'default_value' => NULL,
  ...
  [
    'name' => 'CustomGroup_official_info_CustomField_electoral_official_level',
    'entity' => 'CustomField',
    'cleanup' => 'unused',
    'update' => 'unmodified',
    'params' => [
